...
# display the fruits selected on table
streamlit.dataframe(fruits_to_show)


def get_fruityvice_data(this_choice):
  fruityvice_response = requests.get("https://fruityvice.com/api/fruit/"+this_choice)
...
try:
  ...
  streamlit.error()
# stop streamlit when we troubleshoot
...
if streamlit.button('Add a fruit to the list'):
  my_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake"])
  my_data_row = insert_row_snowflake(fruit)
